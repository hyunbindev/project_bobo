...
const awards: ClanAward[] = [
  {
    ...
    code: "BOOST ADDICT",
    title: "아! 취한다",
    description: "진통제, 에너지 드링크, 아드레날린을 판당 가장 많이 사용했어.",
    metric: "판당 부스트",
    icon: Pill,
    tone: "primary",
    rankings: [
  ...
  },
  {
    ...
    code: "FIELD MEDIC",
    title: "야전 의무병",
    description: "쓰러진 팀원을 가장 자주 다시 전장으로 복귀시켰어.",
    metric: "판당 부활",
    icon: HeartPulse,
    tone: "support",
    rankings: [
  ...
  },
  {
    ...
    code: "BANDAGE MUMMY",
    title: "붕대 감는 미라",
    description: "회복 아이템을 판당 가장 꼼꼼하게 챙겨 사용했어.",
    metric: "판당 회복",
    icon: Activity,
    tone: "success",
    rankings: [
  ...
  },
  {
    ...
    code: "HEAD HUNTER",
    title: "머리만 노린다",
    description: "전체 킬 중 헤드샷 비율이 가장 높은 명사수야.",
    metric: "헤드샷 비율",
    icon: Target,
    tone: "info",
    rankings: [
  ...
  },
  {
    ...
    code: "ONE SHOT",
    title: "한 발이면 충분해",
    description: "지난 14일 동안 가장 먼 거리에서 적을 정리했어.",
    metric: "최장거리 킬",
    icon: Trophy,
    tone: "primary",
    rankings: [
  ...
  },
  {
    ...
    title: "김기사",
    description: "클랜원들을 태우고 판당 가장 먼 거리를 운행했어.",
    metric: "판당 차량 이동",
    icon: Car,
    tone: "support",
    rankings: [
